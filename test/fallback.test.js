...
test('확정값 반영은 한 번의 finalize 호출로 관련 문단만 고친다', () => {
  ...
  assert.match(apiSource, /const ACTIONS = \['analyze', 'master', 'masterDesign', 'masterPlan', 'draftPart', 'draft', 'fullProposal', 'preciseReview', 'patchSections', 'rewrite', 'finalize', CORE_PROPOSAL_ACTION, DIAGNOSIS_ACTION];/);
