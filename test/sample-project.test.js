...
test('샘플은 별도 화면에서만 열리고 현재 작업 상태를 덮어쓰지 않는다', () => {
  assert.match(appSource, /const tools = \{ home: homeView, coaching: coachingView, applicants: applicantsToolView, sample: sampleView, engagement: engagementView, account: accountView \}/);
