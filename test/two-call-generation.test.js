...
test('계획서 생성은 설계안 1회 + 전체 작성 1회 구조를 쓴다', () => {
  ...
  assert.match(api, /const ACTIONS = \['analyze', 'master', 'masterDesign', 'masterPlan', 'draftPart', 'draft', 'fullProposal', 'preciseReview', 'patchSections', 'rewrite', 'finalize', CORE_PROPOSAL_ACTION, DIAGNOSIS_ACTION];/);
